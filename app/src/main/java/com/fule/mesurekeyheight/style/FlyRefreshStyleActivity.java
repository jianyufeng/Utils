package com.fule.mesurekeyheight.style;
 ...
 */
        ...
        appBar.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                Log.d(fraction+"::::FlyRefreshStyleActivity", "scrollRange:" + scrollRange+";verticalOffset:"+verticalOffset);
                if (fraction < 0.1 && misAppbarExpand) {
                    //AppBarLayout 收缩到 0.1的比率时
                    misAppbarExpand = false; //mActionButton  缩小直到隐藏；  小飞机也一样
    ...
    private void initDataSet() {
     ...
     class ElasticOutInterpolator implements Interpolator {
